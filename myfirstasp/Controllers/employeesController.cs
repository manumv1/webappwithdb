...
namespace myfirstasp.Controllers
{
    ...
    {
        private readonly myfirstaspContext _context;

        public employeesController(myfirstaspContext context)
        {
            _context = context;
        }
        ...
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for #tst update#
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
